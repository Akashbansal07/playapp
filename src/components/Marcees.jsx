...
function Marcees() {
    var val=[
        ...
        ["The Gentleman : 8.3 Imdb","Poor Things : 8.0 Imdb","Dune Part Two : 8.8 Imbd","Damsel : 6.1 Imbd","Shogun : 9.2 Imbd","Oppenheimer : 8.3 Imbd","Dune Part One : 8.0 Imdb","The Holdovers : 8.0 Imbd"]
    ];
  return (
