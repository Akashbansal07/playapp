...
const mover = (val)=>{
  ...
  return (
    ...
    <video className='object-cover aspect-[3/2.2]' src="https://cdn-useast1.kapwing.com/collections/final_629ab1d2163bae00885a101f_71856.mp4" type="video/mp4"  autoPlay muted loop></video>
</motion.div>
