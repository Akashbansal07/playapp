...
<motion.div transition={{ease:[0.76,0,0.24,1], duration: .4}} animate={{y:-pos+`rem`}} className='w-full h-full left-1/3 rounded-lg'>
    <video className='object-cover aspect-[3/2.3]' src="/public/src/videos/Prime.mp4" type="video/mp4"  autoPlay muted loop></video>
</motion.div>
<motion.div transition={{ease:[0.76,0,0.24,1], duration: .4}} animate={{y:-pos+`rem`}} className='w-full h-full left-1/3 rounded-lg'>
    <video src="./src/videos/disney.mp4" type="video/mp4"  autoPlay muted loop></video>
</motion.div>
<motion.div transition={{ease:[0.76,0,0.24,1], duration: .4}} animate={{y:-pos+`rem`}} className='w-full h-full left-1/3 rounded-lg'>
    <video className='object-cover aspect-[4/2.8]' src="./public/src/videos/zee5.mp4" type="video/mp4" autoPlay muted loop></video>
</motion.div>
<motion.div transition={{ease:[0.76,0,0.24,1], duration: .4}} animate={{y:-pos+`rem`}} className='w-full h-full left-1/3 rounded-lg'>
